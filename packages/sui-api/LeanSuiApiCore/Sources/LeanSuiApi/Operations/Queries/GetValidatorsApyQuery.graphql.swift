...
extension SuiGraphQL {
  nonisolated struct GetValidatorsApyQuery: GraphQLQuery {
    static let operationName: String = "getValidatorsApy"
    static let operationDocument: ApolloAPI.OperationDocument = .init(
      definition: .init(
        #"query getValidatorsApy { epoch { __typename epochId validatorSet { __typename contents { __typename json } } } }"#
      ))
    ...
    nonisolated struct Data: SuiGraphQL.SelectionSet {
      ...
      static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] {
        [
          GetValidatorsApyQuery.Data.self
        ]
      }
      ...
      nonisolated struct Epoch: SuiGraphQL.SelectionSet {
        ...
        static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] {
          [
            GetValidatorsApyQuery.Data.Epoch.self
          ]
        }
        ...
        nonisolated struct ValidatorSet: SuiGraphQL.SelectionSet {
          ...
          static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] {
            [
              GetValidatorsApyQuery.Data.Epoch.ValidatorSet.self
            ]
          }
          ...
          nonisolated struct Contents: SuiGraphQL.SelectionSet {
            ...
            static var __fulfilledFragments: [any ApolloAPI.SelectionSet.Type] {
              [
                GetValidatorsApyQuery.Data.Epoch.ValidatorSet.Contents.self
              ]
            }
